...
[T2,X,T_1_2,colors]=findT('../data/matchesSIFT1.txt','../data/im1.png','../data/im2.png',K1)
show_point_cloud(X,T1,ax,1,colors,
        xlim=[-1.6,+0.6],
        zlim=[-1.6,+0.6],
        ylim=[+2.0,+4.2])
T_c1_cn=np.eye(4)
[T2,X,T_1_2,colors]=findT('../data/matchesSIFT'+str(1)+'.txt','../data/im1.png','../data/im2.png',K1)
#     T_c1_cn=T2@T_c1_cn 
